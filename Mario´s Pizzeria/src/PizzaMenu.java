...
public class PizzaMenu {
  ...
  public PizzaMenu() {
    ...
    pizzaMenu.add(new Pizza(19, "QUATTRO STAGIONI ", "tomat, ost, champignon, pepperoni og artiskok     ",85));
    ...
    pizzaMenu.add(new Pizza(27, "OPERA            ", "tomat, ost, gorgonzola, parmaskinke               ",85));
    pizzaMenu.add(new Pizza(28, "CANNES           ", "tomat, ost, pepperoni, italiensk skinke           ",89));
